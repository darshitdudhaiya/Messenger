...
const SignupPage = () => {
  ...
  if (session) {
    ...
    return (
      <>
        <div className="max-w-screen-xl py-6 sm:mx-28 sm:rounded-lg flex justify-center flex-1">
              ...
              <div className="w-full flex-1 mt-5">
                ...
                <div className="mx-auto max-w-xs my-5">
                  ...
                  <input
                    ...
                    id="conformpassword"
                  />
                  <button onClick={() => Credentials()} type="submit" className="mt-5 tracking-wide font-semibold bg-white border border-gray-400 w-full py-4 rounded-lg hover:bg-[#F53855] hover:border-[#F53855] hover:text-white transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                    <svg
                  ...
                  <Link href='/components/Signin'>
                    <p className="text-sm font-light text-gray-500 dark:text-gray-400 mt-4 cursor-pointer">
                      I have an account? <a href="" className="font-medium text-[#F53855] hover:underline">Signin here</a>
                    </p>
                  </Link>
                </div>
              </div>
